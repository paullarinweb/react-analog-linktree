...
function App() {
  ...
  <Main>
    <Profile/>
    <DownloadLink name={"Basic HTML Template"} source={'./assets/pages/basic.txt'} styles={"link border-gray-200 bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500"}/>
